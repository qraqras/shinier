        ...
        while left < right {
            ...
            if target.is_enclosing(comment) {
                if let Some(enclosing_node) = nodes.iter().find(|node| {
                    node.location().start_offset() == target_start && node.location().end_offset() == target_end
                }) {
...
pub fn push_statements_opt<'sh>(nodes: &mut Vec<Node<'sh>>, statements: Option<StatementsNode<'sh>>) {
...
pub fn push_rescue_clauses_opt<'sh>(nodes: &mut Vec<Node<'sh>>, rescue_clauses: Option<RescueNode<'sh>>) {
...
pub fn push_ensure_clause_opt<'sh>(nodes: &mut Vec<Node<'sh>>, ensure_clause: Option<EnsureNode<'sh>>) {
    if let Some(ensure_clause) = ensure_clause {
        nodes.push(ensure_clause.as_node());
    }
}
pub fn push_parameters_opt<'sh>(nodes: &mut Vec<Node<'sh>>, parameters: Option<ParametersNode<'sh>>) {
...
pub fn comment_targets_of_alias_method_node<'sh>(node: &AliasMethodNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.keyword_loc());
    push_node(&mut nodes, node.new_name());
...
pub fn comment_targets_of_and_node<'sh>(node: &AndNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.operator_loc());
    push_node(&mut nodes, node.left());
...
pub fn comment_targets_of_arguments_node<'sh>(node: &ArgumentsNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let locations = Vec::new();
    let mut nodes = Vec::new();
    push_nodelist(&mut nodes, node.arguments());
    (locations, nodes)
}
pub fn comment_targets_of_array_node<'sh>(node: &ArrayNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
...
pub fn comment_targets_of_assoc_node<'sh>(node: &AssocNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
...
pub fn comment_targets_of_assoc_splat_node<'sh>(node: &AssocSplatNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.operator_loc());
...
pub fn comment_targets_of_block_node<'sh>(node: &BlockNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
...
pub fn comment_targets_of_break_node<'sh>(node: &BreakNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.keyword_loc());
...
pub fn comment_targets_of_call_node<'sh>(node: &CallNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc_opt(&mut locations, node.call_operator_loc());
    push_loc_opt(&mut locations, node.message_loc());
...
pub fn comment_targets_of_call_or_write_node<'sh>(node: &CallOrWriteNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc_opt(&mut locations, node.call_operator_loc());
    push_loc_opt(&mut locations, node.message_loc());
...
pub fn comment_targets_of_call_target_node<'sh>(node: &CallTargetNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
...
pub fn comment_targets_of_case_match_node<'sh>(node: &CaseMatchNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
...
pub fn comment_targets_of_case_node<'sh>(node: &CaseNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.case_keyword_loc());
    push_loc(&mut locations, node.end_keyword_loc());
...
pub fn comment_targets_of_class_node<'sh>(node: &ClassNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
...
pub fn comment_targets_of_def_node<'sh>(node: &DefNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.name_loc());
...
pub fn comment_targets_of_defined_node<'sh>(node: &DefinedNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc_opt(&mut locations, node.lparen_loc());
    push_loc_opt(&mut locations, node.rparen_loc());
...
pub fn comment_targets_of_ensure_node<'sh>(node: &EnsureNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
...
pub fn comment_targets_of_false_node<'sh>(node: &FalseNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
}
pub fn comment_targets_of_find_pattern_node<'sh>(node: &FindPatternNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc_opt(&mut locations, node.opening_loc());
    push_loc_opt(&mut locations, node.closing_loc());
...
pub fn comment_targets_of_flip_flop_node<'sh>(node: &FlipFlopNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.operator_loc());
...
pub fn comment_targets_of_float_node<'sh>(node: &FloatNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
}
pub fn comment_targets_of_for_node<'sh>(node: &ForNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
...
pub fn comment_targets_of_hash_node<'sh>(node: &HashNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.opening_loc());
    push_loc(&mut locations, node.closing_loc());
...
pub fn comment_targets_of_hash_pattern_node<'sh>(node: &HashPatternNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc_opt(&mut locations, node.opening_loc());
    push_loc_opt(&mut locations, node.closing_loc());
...
pub fn comment_targets_of_imaginary_node<'sh>(node: &ImaginaryNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
}
pub fn comment_targets_of_implicit_node<'sh>(node: &ImplicitNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let locations = Vec::new();
    let mut nodes = Vec::new();
    push_node(&mut nodes, node.value());
    (locations, nodes)
...
pub fn comment_targets_of_index_target_node<'sh>(node: &IndexTargetNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.opening_loc());
    push_loc(&mut locations, node.opening_loc());
...
pub fn comment_targets_of_integer_node<'sh>(node: &IntegerNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
...
pub fn comment_targets_of_keyword_hash_node<'sh>(node: &KeywordHashNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let locations = Vec::new();
    let mut nodes = Vec::new();
    push_nodelist(&mut nodes, node.elements());
    (locations, nodes)
...
pub fn comment_targets_of_lambda_node<'sh>(node: &LambdaNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.operator_loc());
    push_loc(&mut locations, node.opening_loc());
...
pub fn comment_targets_of_match_write_node<'sh>(node: &MatchWriteNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let locations = Vec::new();
    let mut nodes = Vec::new();
    push_nodelist(&mut nodes, node.targets());
    (locations, nodes)
}
pub fn comment_targets_of_missing_node<'sh>(node: &MissingNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
}
pub fn comment_targets_of_module_node<'sh>(node: &ModuleNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
...
pub fn comment_targets_of_multi_target_node<'sh>(node: &MultiTargetNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc_opt(&mut locations, node.lparen_loc());
    push_loc_opt(&mut locations, node.rparen_loc());
...
pub fn comment_targets_of_multi_write_node<'sh>(node: &MultiWriteNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc_opt(&mut locations, node.lparen_loc());
    push_loc_opt(&mut locations, node.rparen_loc());
...
pub fn comment_targets_of_next_node<'sh>(node: &NextNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.keyword_loc());
    push_arguments_opt(&mut nodes, node.arguments());
...
pub fn comment_targets_of_nil_node<'sh>(node: &NilNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
...
pub fn comment_targets_of_parameters_node<'sh>(node: &ParametersNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let locations = Vec::new();
    let mut nodes = Vec::new();
    push_nodelist(&mut nodes, node.requireds());
    push_nodelist(&mut nodes, node.optionals());
    push_node_opt(&mut nodes, node.rest());
    push_nodelist(&mut nodes, node.posts());
    push_nodelist(&mut nodes, node.keywords());
    push_node_opt(&mut nodes, node.keyword_rest());
    if let Some(block) = node.block() {
        push_node(&mut nodes, block.as_node());
    }
    (locations, nodes)
}
pub fn comment_targets_of_parentheses_node<'sh>(node: &ParenthesesNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.opening_loc());
    push_loc(&mut locations, node.closing_loc());
...
pub fn comment_targets_of_pinned_expression_node<'sh>(
    ...
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.operator_loc());
    push_loc(&mut locations, node.lparen_loc());
    push_loc(&mut locations, node.rparen_loc());
    push_node(&mut nodes, node.expression());
    (locations, nodes)
}
...
pub fn comment_targets_of_program_node<'sh>(node: &ProgramNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let locations = Vec::new();
    let mut nodes = Vec::new();
    push_node(&mut nodes, node.statements().as_node());
    (locations, nodes)
}
pub fn comment_targets_of_range_node<'sh>(node: &RangeNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.operator_loc());
    push_node_opt(&mut nodes, node.left());
...
pub fn comment_targets_of_rational_node<'sh>(node: &RationalNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
}
pub fn comment_targets_of_redo_node<'sh>(node: &RedoNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
...
pub fn comment_targets_of_rescue_modifier_node<'sh>(
    ...
    push_loc(&mut locations, node.keyword_loc());
    push_node(&mut nodes, node.expression());
    push_node(&mut nodes, node.rescue_expression());
    (locations, nodes)
}
pub fn comment_targets_of_rescue_node<'sh>(node: &RescueNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.keyword_loc());
    push_loc_opt(&mut locations, node.operator_loc());
    push_loc_opt(&mut locations, node.then_keyword_loc());
    push_nodelist(&mut nodes, node.exceptions());
    push_node_opt(&mut nodes, node.reference());
    push_statements_opt(&mut nodes, node.statements());
...
pub fn comment_targets_of_retry_node<'sh>(node: &RetryNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
}
pub fn comment_targets_of_return_node<'sh>(node: &ReturnNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.keyword_loc());
    push_arguments_opt(&mut nodes, node.arguments());
...
pub fn comment_targets_of_self_node<'sh>(node: &SelfNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
...
pub fn comment_targets_of_shareable_constant_node<'sh>(
    ...
    let locations = Vec::new();
    let mut nodes = Vec::new();
    push_node(&mut nodes, node.write());
    (locations, nodes)
}
...
pub fn comment_targets_of_source_file_node<'sh>(node: &SourceFileNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
}
pub fn comment_targets_of_source_line_node<'sh>(node: &SourceLineNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
}
pub fn comment_targets_of_splat_node<'sh>(node: &SplatNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.operator_loc());
    push_node_opt(&mut nodes, node.expression());
...
pub fn comment_targets_of_statements_node<'sh>(node: &StatementsNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let locations = Vec::new();
    let mut nodes = Vec::new();
    push_nodelist(&mut nodes, node.body());
    (locations, nodes)
}
pub fn comment_targets_of_string_node<'sh>(node: &StringNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc_opt(&mut locations, node.opening_loc());
    push_loc(&mut locations, node.content_loc());
...
pub fn comment_targets_of_super_node<'sh>(node: &SuperNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.keyword_loc());
    push_loc_opt(&mut locations, node.lparen_loc());
...
pub fn comment_targets_of_symbol_node<'sh>(node: &SymbolNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc_opt(&mut locations, node.opening_loc());
    push_loc_opt(&mut locations, node.value_loc());
    push_loc_opt(&mut locations, node.closing_loc());
    (locations, nodes)
}
pub fn comment_targets_of_true_node<'sh>(node: &TrueNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.location());
    (locations, nodes)
}
pub fn comment_targets_of_undef_node<'sh>(node: &UndefNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.keyword_loc());
    push_nodelist(&mut nodes, node.names());
    (locations, nodes)
}
pub fn comment_targets_of_unless_node<'sh>(node: &UnlessNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.keyword_loc());
    push_loc_opt(&mut locations, node.then_keyword_loc());
...
pub fn comment_targets_of_until_node<'sh>(node: &UntilNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.keyword_loc());
    push_loc_opt(&mut locations, node.do_keyword_loc());
...
pub fn comment_targets_of_when_node<'sh>(node: &WhenNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.keyword_loc());
    push_loc_opt(&mut locations, node.then_keyword_loc());
...
pub fn comment_targets_of_while_node<'sh>(node: &WhileNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.keyword_loc());
    push_loc_opt(&mut locations, node.do_keyword_loc());
...
pub fn comment_targets_of_x_string_node<'sh>(node: &XStringNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let nodes = Vec::new();
    push_loc(&mut locations, node.opening_loc());
    push_loc(&mut locations, node.content_loc());
...
pub fn comment_targets_of_yield_node<'sh>(node: &YieldNode<'sh>) -> (Vec<Location<'sh>>, Vec<Node<'sh>>) {
    let mut locations = Vec::new();
    let mut nodes = Vec::new();
    push_loc(&mut locations, node.keyword_loc());
    push_loc_opt(&mut locations, node.lparen_loc());
