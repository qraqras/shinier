// filepath: /workspaces/shinier/crates/shinier_rb_formatter/src/builder/prism/new_build_node_variant/class_variable_read_node.rs
...
use crate::builder::prism::new_layout_node_variant::class_variable_read_node::{
    LayoutParamClassVariableReadNode, layout_class_variable_read_node,
};
use crate::keyword::*;
use ruby_prism::*;

fn build_class_variable_read_node(
    node: &ClassVariableReadNode<'_>,
